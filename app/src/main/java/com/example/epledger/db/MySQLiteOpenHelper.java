...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    private String sql_create_table = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (" +istemplate+" int DEFAULT 0, "+id2+" INTEGER PRIMARY KEY AUTOINCREMENT,"+date1 + " date," + account + " int," + type1 + " varchar(200)," + from1 + " varchar(200),"+ beizhu + " varchar(300), " + star + " int DEFAULT 0, "+ bitmap + " varchar(300),"+iconresid+" int" +")";
    private String sql_create_type = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME2 + " (" +id1+" INTEGER PRIMARY KEY AUTOINCREMENT,"+type1 + " varchar(200)" +")";
    ...
    private String sql_create_id_type = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME3 + " (" +id1+" int ,"+id2 + " int" +")";
    private String sql_create_id_from = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME6 + " (" +from_id+" int ,"+id2 + " int" +")";
    ...
    public static final String id1= "type_id";
    public static final String id2= "record_id";
